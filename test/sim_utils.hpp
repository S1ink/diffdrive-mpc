...
/// Integrates (x, y, θ) forward by one timestep using the exact kinematics.
...
/// Sharp 90° L-shaped path (tests corner deceleration).
Path makeSharpLPath();
...
/// Adds independent Gaussian noise to position (x, y) and heading (θ).
